...
<body>
    ...
    <div class="login">
        <form>
            ...
            <div class="image">
                ...
                <img src="Facebook Logo.png" width="25px">
    ...
    <footer class="t">
        Designed and Developed by SANJAI S &copy; 2023
    </footer>
...
<body>
    <header>
        ...
        <div class="cirpic">
            <img class="small border" src="Person 1.png" width="500px">
            <img class="small border" src="Person 2.jpeg" width="500px" >
            <img class="small border" src="Person 3.jpg" width="500px">
            <img class="small border" src="Person 4.jpg" width="500px" >
            
        </div>
        <div class ="text">
            <table cellpadding="63
    ...
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            ...
            <div class="contain">
                <table >
                    <tr>
                        <td><img src="web logo.png" height="200px" width="200px">
                            <p><b>WEB DESIGN<br>&nbsp;&nbsp;AND&nbsp;DEVELOPMENT</b><br>
                                
                               
                
                        </p></td>
                        <td><img src="javascripts logo.png" height="200px" width="200px"><br>
                            <p><b>JAVASCRIPT&nbsp;</b><br>
                                
                                
                        </p></td>
                        <td><img src="python logo.png" height="200px" width="200px"><br>
                            <p><b>PHYTHON <br>
                        ...
                        <td><img src="C logo.png" height="200px" width="200px"><br>
                            <p><b>C/C++</b><br>
...
<head>
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Address: </b>1266 mariyammankoil street panruti,cuddalore district 607106<br><br>
